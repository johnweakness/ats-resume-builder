...
export const RESUME_TEMPLATES = [
  ...
  },
  {
    ...
    build: () => ({
      ...emptyResume(),
      objective:
        "Recent [Degree] graduate from [University] with hands-on experience as a working student in [Field], seeking an entry-level [Target Role] position to apply both academic training and practical work experience.",
      education: [
        {
          id: newId("edu"),
          degree: "Bachelor of Science in [Your Program]",
