  ...
  return (
    <Document title={fullName ? `${fullName} - Resume` : "Resume"}>
      <Page size="A4" style={styles.page}>
        ...
        <CredentialSection heading="Seminars & Trainings" entries={seminarsTrainings} />
        <CredentialSection heading="Awards & Achievements" entries={awardsAchievements} />
...
function TextSection({ heading, text }) {
  return <Section heading={heading}><Text style={styles.paragraph}>{text}</Text></Section>;
}
