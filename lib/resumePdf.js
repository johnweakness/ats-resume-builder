      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.headerRow}>
          <View style={{ flex: 1, paddingRight: photo ? 84 : 0 }}>
            ...
            {contactLine ? <Text style={[styles.contact, photo ? { marginTop: 3, paddingVertical: 3, borderTopWidth: 0, borderBottomColor: BLUE, textAlign: "left" } : null]}>{contactLine}</Text> : null}
          </View>
