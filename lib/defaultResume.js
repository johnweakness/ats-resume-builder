...
export function normalizeResume(raw = {}) {
  ...
  return {
    ...
    education,
    experienceHeading: raw.experienceHeading || "EXPERIENCE",
    experience,
    skills: raw.skills || "",
  };
}
...
export const sampleResume = {
  ...
  objective:
    "To pursue a Web Developer / AI Web Developer role where I can use my skills in modern web development and AI-assisted coding to build, improve, and maintain responsive and user-friendly websites. I aim to contribute to real business and marketing needs by creating practical web solutions, troubleshooting existing systems, and continuously improving my development skills while working effectively with a team.",
  education: [
    {
      id: newId("edu"),
