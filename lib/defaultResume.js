...
export function getMissingResumeFields(data = {}) {
  ...
  const experienceLabel = data.experienceHeading === "PROJECTS" ? "Projects" : "Experience";
  const hasExperience =
  ...
  if (!hasExperience) missing.push(`${experienceLabel} (title, role, and at least one bullet)`);
